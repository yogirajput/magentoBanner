<?php
namespace Yogesh\Banner\Block\Adminhtml\Banner;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \Yogesh\Banner\Model\Status
     */
    protected $_status;
    ...
    public function __construct(
        ...
        \Yogesh\Banner\Model\Status $status,
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setTemplate('Yogesh_Banner::banner/grid/massaction_extended.phtml');
    ...
    /**
     * @param \Yogesh\Banner\Model\banner|\Magento\Framework\Object $row
     * @return string
     */
    ...
    {
        return ['0' => __('Homepage Banner'), '1' => __('Blog Banner')];
    }
}