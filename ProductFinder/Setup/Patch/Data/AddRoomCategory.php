...
class AddRoomCategory implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $eavSetup->removeAttribute(\Magento\Catalog\Model\Product::ENTITY, 'room_category');
        $eavSetup->addAttribute(\Magento\Catalog\Model\Product::ENTITY, 'room_category', [
            'type' => 'text',
            'backend' => '',
            'frontend' => '',
            'label' => 'Room Type',
            ...
            'source' => 'Yogesh\ProductFinder\Model\Product\RoomCategory\Option',
        ...
        $this->assignToAllAttributeSets('room_category');
    }
