...
class AddBlindCategory implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $eavSetup->removeAttribute(\Magento\Catalog\Model\Product::ENTITY, 'blind_category');
        $eavSetup->addAttribute(\Magento\Catalog\Model\Product::ENTITY, 'blind_category', [
            'type' => 'text',
            'backend' => '',
            'frontend' => '',
            'label' => 'Room Type',
            ...
            'source' => 'Yogesh\ProductFinder\Model\Product\BlindCategory\Option',
        ...
        $this->assignToAllAttributeSets('blind_category');
    }
